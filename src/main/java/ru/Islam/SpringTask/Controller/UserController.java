package ru.Islam.SpringTask.Controller;
...
import ru.Islam.SpringTask.Service.UserService;
...
public class UserController {
    ...
    public String showAddUserForm(ModelMap model) {
        ...
        return "userAdd"; // возвращает страницу с формой для добавления пользователя
    }
